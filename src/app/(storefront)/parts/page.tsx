  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative pt-32 pb-24 px-6 overflow-hidden flex flex-col items-center justify-center text-center">
        ...
        <div className="absolute top-20 left-1/4 w-[300px] h-[300px] bg-gray-200/50 rounded-full pointer-events-none blur-3xl mix-blend-multiply"></div>
        
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-6xl md:text-[84px] font-semibold tracking-tighter text-[#1d1d1f] leading-[1.05] mb-6">
            Spare Parts. <br className="hidden md:block" />
            <span className="text-[#6e6e73]">Fix it. Keep it going.</span>
          </h1>
          <p className="text-xl md:text-2xl text-[#424245] font-medium tracking-tight">
            Original OEM parts for the perfect repair.
          </p>
        </div>
      </div>
      ...
      <div className="sticky top-[52px] z-30 w-full bg-white/80 backdrop-blur-md border-b border-gray-100 py-4 mb-12">
        <div className="max-w-[1440px] mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-6 text-sm font-medium text-[#6e6e73]">
            <span className="text-[#1d1d1f] font-semibold">All Parts</span>
            <span className="hover:text-[#1d1d1f] cursor-pointer transition-colors">Displays</span>
            <span className="hover:text-[#1d1d1f] cursor-pointer transition-colors">Batteries</span>
            <span className="hover:text-[#1d1d1f] cursor-pointer transition-colors">Cameras</span>
          </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 pb-32">
        {products && products.length > 0 ? (
          ...
          <div className="text-center py-32 flex flex-col items-center justify-center bg-[#f5f5f7] rounded-[40px] mx-4">
            <h3 className="text-2xl font-semibold text-[#1d1d1f] mb-2">No parts available</h3>
